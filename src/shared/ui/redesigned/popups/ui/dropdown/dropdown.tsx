...
import { AppLinkRedesigned, classNames } from '@/shared';
...
const Dropdown = (props: DropdownProps) => {
  ...
  const additional = [className, styles[direction], styles.menu];
  ...
  return (
    ...
    >
      ...
      <Menu.Items className={classNames(styles.menuDropdown, {}, additional)}>
...
export { Dropdown as DropdownRedesigned };
